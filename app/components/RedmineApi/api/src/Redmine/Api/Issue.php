...
class Issue extends AbstractApi
{
    ...
    private function cleanParams(array $params = [])
    {
        ...
        if (isset($params['assigned_to'])) {
            ...
            $params['assigned_to_id'] = $apiUser->getIdByUsername($params['assigned_to'], ['offset' => 0, 'limit' => 100]);
            unset($params['assigned_to']);
        }
        if (isset($params['author'])) {
            $apiUser = $this->client->user;
            $params['author_id'] = $apiUser->getIdByUsername($params['author'], ['offset' => 0, 'limit' => 100]);
            unset($params['author']);
        }
